...
# Configuraciones adicionales al inicio del script
torch.backends.cudnn.benchmark = True  # Optimiza operaciones repetitivas
torch.backends.cuda.matmul.allow_tf32 = True  # Permite TF32 para mayor velocidad
...
# Configuración optimizada del modelo principal
...
def train_optimized():
    ...
    gradient_accumulation_steps = 4  # Reducido para compensar el mayor batch size
